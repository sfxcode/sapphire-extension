...
class ShowcaseViewController extends ShowcaseController with LazyLogging {
  ...
  private val propertiesFormItem = ShowcaseItem("Form", "Properties Form", () => getController[PropertiesFormController]())
  private val controlsfxFormItem = ShowcaseItem("Form", "ControlsFX", () => getController[ExtensionFormController]())
  private val controllerMasterItem = ShowcaseItem("Controller", "Master / Detail", () => getController[PersonMasterController]())
  ...
  private val dataTableExtendedItem = ShowcaseItem("DataTable", "Extended", () => getController[PersonTableController]())

  private val items = List(formItem, listFormItem, dualListFormItem, propertiesFormItem, controlsfxFormItem, fontIconItem, controllerMasterItem,
    tableBaseItem, dataTableBaseItem, dataTableExtendedItem)
